...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // After success, navigate to login or auto-login
      navigate('/login');
    } catch (err) {
    ...
    <div className="max-w-md mx-auto mt-12">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-50">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-blue-900 mb-2">Join MindEezy</h2>
          <p className="text-slate-500">Start your journey to better mental health today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Psychology Enthusiast"
                value={username}
          ...
          >
            {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : <><UserPlus className="mr-2 h-5 w-5" /> Sign Up</>}
          </button>
        </form>
